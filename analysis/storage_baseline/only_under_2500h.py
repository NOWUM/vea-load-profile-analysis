...
def compare(uri: str, images_dir: str | Path):
    ...
    battery_size_fig.update_xaxes(range=[0, 300])
    ...
    battery_investments_fig.update_xaxes(range=[0, 75000])
    ...
    battery_annuity_fig.update_xaxes(range=[0, 6000])
    ...
    total_yearly_savings_fig.update_xaxes(range=[0, 15e3])
    ...
    perc_yearly_savings_fig.update_xaxes(range=[0, 15])
    ...
    total_cap_savings_fig.update_xaxes(range=[0, 25e3])
